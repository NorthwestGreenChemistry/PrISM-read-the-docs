...
![](./assets/7-evaluation-and-optimization/path-to-optimization.png)
...
Data gaps in hazard information are also likely. A tiered approach to hazard screening that begins with hazard list screening and moves to intermediate and then more comprehensive approaches to chemical hazard assessment is appropriate. See [Resource 2 - Chemical Hazard Assessment](./resource2-chemical-hazard-assessment.html) for guidance and suggestions. Using life cycle thinking to narrow the focus of the assessment to those elements that discriminate between options helps to limit data needs. See [Resource 6 - Life Cycle Assessment](http://github.com/NorthwestGreenChemistry/PrISM/blob/develop/app/content/resource6-life-cycle-assessment.html) for guidance and suggestions.
...
[Go to Resources: Decision Analysis](./resource7-decision-analysis.html)
...
![PASS Principles](./assets/7-evaluation-and-optimization/NGCPASSPrinciples.png)
...
![](./assets/7-evaluation-and-optimization/decision-logic.png)
...
[Learn more about decision analysis in Resource 7 - Decision Analysis](./resource7-decision-analysis.html)
